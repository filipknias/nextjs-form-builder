...
export default function NumberField({ label, placeholder, helperText, required }: Props) {
  return (
    <Card className="px-4 py-8">
        <CardTitle className="font-semibold text-base mb-2 text-white">{label}</CardTitle>
        <Input type="number" className="w-full mb-2" placeholder={placeholder} required={required} />
